  ...
  constructor(options) {
    let config = {
      ...
      classes: {
        ...
        popupContent: "popup-rules__content",
        popupActive: "popup-rules_show", // Добавляется для попапа, когда он открывается
        bodyActive: "popup-rules-show", // Добавляется для боди, когда попап открыт
      },
...
flsModules.popup = new PopupRules({});
